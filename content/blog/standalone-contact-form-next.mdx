...
I recently built a custom contact form for my [personal website](https://haydenbleasel.com/contact) for allowing visitors to send me emails. While this sounds pretty basic, I had a few constraints that made the solution a bit more complex.
