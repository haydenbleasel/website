...
Next up is identifying users. This is super trivial as we _should_ know when a user has logged in or out on our app. In this example, we'll make use of the [useUser and useProfile hooks](https://dev.to/haydenbleasel/neat-user-and-profile-react-hooks-for-firebase-v9-jh3) we talked about previously.
