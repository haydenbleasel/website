    ...
    typography: ({ theme }) => ({
      invert: {
        css: {
          ...
          '--tw-prose-pre-inner-bg': 'var(--tw-prose-invert-pre-inner-bg)',
      ...
      DEFAULT: {
        css: {
          ...
          '--tw-prose-pre-inner-bg': theme('colors.white'),
          ...
          '--tw-prose-invert-pre-inner-bg': theme('colors.zinc.800'),
          ...
          pre: {
            ...
            borderRadius: theme('borderRadius.3xl'),
            border: `${theme('borderWidth.DEFAULT')} solid var(--tw-prose-pre-border)`,
          ...
          'pre code': {
            ...
            border: `${theme('borderWidth.DEFAULT')} solid var(--tw-prose-pre-border)`,
            borderRadius: '20px',
            backgroundColor: 'var(--tw-prose-pre-inner-bg)',
            width: '100%',
            display: 'block',
            counterReset: 'line',
            fontWeight: 'normal',
