...
date: 04-02-2022
image: /blog/posts/spotify-no-auth-preview.png
---
...
As it turns out, there's quite a lot we can do! So today we're going to be building a simple Spotify playlist preview with Next.js! Here's [a preview](https://spotify-preview-demo.haydenbleasel.com/) we're going to be building, or you can browse the [source code](https://github.com/haydenbleasel/spotify-preview-demo).
