...
- Collaborated with a multi-disciplinary design team on anti-fraud pilot project.
- Partnered closely with Engineering, Strategy and Research teams.
- Designed a node-based graphing system with histogram, object and document viewer.
- Contribute to internal (now open-source) design system called Blueprint.
- Produced interactive, animated prototypes to sell concepts to wider team.
- Wireframing and ideation solutions for complex UI and data problems.
