...
I'll assume that you've setup your [local Firebase instance](https://dev.to/haydenbleasel/using-the-firebase-local-emulator-with-expo-s-managed-workflow-5g5k) and start off by implementing Google and Apple sign in systems.
