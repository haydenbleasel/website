      ...
      <div className="grid grid-cols-1 gap-y-16 lg:grid-cols-2 lg:grid-rows-[auto_1fr] lg:gap-y-12">
        ...
        <div className="lg:order-first lg:row-span-2">
          ...
          <Prose>
            ...
            <h2>Orate</h2>
            <p>
              I also made Orate — the AI toolkit for speech. It was a library
              for synthesizing speech, transcribing audio, converting voices and
              isolating audio.
            </p>
            <p>
            ...
            <p>
              ...
              faster. It's effectively a zero-config Biome preset that provides
              a robust linting and formatting experience for your team and your
              AI integrations.
            </p>
            <p>
            ...
            <p>
              I donated the AI components to Vercel in 2025 to form the
              foundation of our new project &mdash;{' '}
              <a
            ...
            <p>
              ...
              including Accenture, AKQA, Amazon, Bentley, Canva, CapGemini,
              Cisco, Experian, ExpressVPN, Google, H&amp;M, Ikea, John Deere,
              Nespresso, PandaDoc, Qantas, Rakuten, Red Bull, Repl.it, Roblox,
              Softbank, Sega, Tiktok, Uber, Washington Post, Wix, Yahoo, Zoho
