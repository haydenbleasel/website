...
It's not the most dense design system I've worked on (that was probably [Blueprint](https://blueprintjs.com/docs/)) due to typical project time / budget constraints but it's a good overview of the sort of quality you can expect from a design system that I work on or manage — everything is rigorously organised, auto-layout, variants, documentation, etc.
