...
import { Textarea } from "@haydenbleasel/design-system/components/ui/textarea"
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        "flex-1 rounded-none border-0 bg-transparent shadow-none outline-hidden ring-0 focus-visible:outline-hidden focus-visible:ring-0 aria-invalid:ring-0 dark:bg-transparent",
        className
      )}
      {...props}
    />
