...
description: React 18 allows you to build client and server components, which can be tricky for making client-side CSS groups.
date: 11-25-2022
image: /blog/posts/currentPageProvider.tsx.png
---
