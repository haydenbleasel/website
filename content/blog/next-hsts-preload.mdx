...
```js title="next.config.mjs" {11-14}
...
In the example above, I've also included [next-secure-headers](https://www.npmjs.com/package/next-secure-headers) as it is a brilliant package that helps you to add a number of security-related headers to your Next.js app.
