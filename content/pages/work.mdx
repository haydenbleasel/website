...
I've had the pleasure of working with open source organizations. You may have seen some of my work out there — [ESLint](https://eslint.org/blog/2022/08/redesigning-eslint/), [Node.js](https://nodejs.org/en/blog/announcements/diving-into-the-nodejs-website-redesign) and [SWC plugins](https://plugins.swc.rs/) for example.
