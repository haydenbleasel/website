  ...
  return (
    <div className="container mx-auto py-48">
      <div className="grid grid-cols-12 gap-8">
        <div className="col-span-6 col-start-4 grid gap-24">
          <div>
            <h1 className="text-md font-normal text-gray-900">{data.name}</h1>
            <p className="text-md font-normal text-gray-400">{data.role}</p>
          </div>
          <div className="grid gap-12">
            {data.sections.map((section, index) => (
              <div key={index} className="grid gap-4">
                <p className="text-sm font-normal text-gray-400">{section.title}</p>
