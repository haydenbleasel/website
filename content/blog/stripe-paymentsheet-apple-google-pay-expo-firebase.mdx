...
- [Firebase Local Emulator Suite](https://firebase.google.com/docs/emulator-suite) to run Firebase locally. I wrote a [short piece](https://dev.to/haydenbleasel/using-the-firebase-local-emulator-with-expo-s-managed-workflow-5g5k) on how to set this up
