...
const InputRef: ForwardRefRenderFunction<HTMLInputElement, InputProps> = (
  ...
  >
    ...
    <input
      className="w-full rounded-sm border border-neutral-200 bg-transparent px-3 py-2 text-md text-neutral-900 outline-neutral-900 placeholder:text-neutral-500 dark:border-neutral-700 dark:text-white"
